...
typedef struct {
    ...
    int cur_x;                 // X position (in pixels) of the top-left corner of the current chunk
    int cur_y;                 // Y position (in pixels) of the top-left corner of the current chunk
    ...
    int cid;                   // Index of the currently processed chunk (note: Faigl uses uint8 in reference comp_module)
